...
int main() {
    ...
    qparticles_sptr->m_qstate_uptr->set_coefficient({2, 0, 0}, {-1, 0});
    qparticles_sptr->m_qstate_uptr->set_coefficient({0, 2, 0}, { 2, 0});
    qparticles_sptr->m_qstate_uptr->set_coefficient({0, 0, 2}, {-1, 0});
    qparticles_sptr->m_qstate_uptr->normalize();
